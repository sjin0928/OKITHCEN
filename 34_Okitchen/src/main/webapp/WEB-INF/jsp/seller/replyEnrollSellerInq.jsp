...
<body>
	...
	<!-- 후기 작성 폼 -->
	 <form action="inqAnsInsert.do?inqId=${inquiry.inqId }" id="inquiryForm" method="POST" enctype="multipart/form-data">
	 ...
	 <div>	
		...
		<div>
			<textarea id="ansContent" name="ansContent" rows="4" cols="50" required></textarea>
		</div>
	</div>
