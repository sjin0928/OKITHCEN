...
<body>
	...
	<!-- 후기 작성 폼 -->
	 <form action="reviewInsert.do?productId=${product.productId}&orderDetailId=${orderDetailId}&userId=${loginUser.userId}" id="reviewForm" method="POST" enctype="multipart/form-data">
