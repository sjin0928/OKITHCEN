...
<div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
		...
		<div class="col-xl-8 col-lg-7">
			...
			<!-- 공지사항 작성 폼 -->
			 <form action="noticeUpdate.do?noticeId=${updateNoticeView.noticeId }" id="reviewForm" method="POST" class="insertForm">
			 ...
			 <div>	
				...
				<div>
					<textarea id="noticeTitle" name="noticeTitle" rows="1" cols="80" required>${updateNoticeView.noticeTitle}</textarea>
				</div>
				<div class="content">
					<label for="noticeContent">내용</label>
				</div>
				<div>
					<textarea id="noticeContent" name="noticeContent" rows="15" cols="80" required>${updateNoticeView.noticeContent}</textarea>
				</div>
			</div>
