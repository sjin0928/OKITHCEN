...
<body>
\${prodReviewList } : ${prodReviewList }<hr>
			...
			<div class="css-pzlq5x e13nsthd1">
				<div class="css-1d3w5wq ef36txc6">
					...
					<div class="css-11kh0cw ef36txc5">
						<!-- 상품 (시작) -->
						<c:forEach items="${prodReviewList }" var="prod">
						<a href="${pageContext.request.contextPath }/product/prodDetail.do?productId=${prod.productId}" class="css-9o2zup e1c07x4813">
							...
							<div class="css-1kpzrna e1c07x489">
								...
								<div class="e1c07x487 discount-price css-1tl7659 ei5rudb2">
									<div>
										<span class="dimmed-price css-18tpqqq ei5rudb1">${prod.price}<span
								...
								<div class="review-count css-xezqwk e1c07x482">
									<span class="css-mz5g71 e1c07x481"><svg width="100%"
										...
										class="review-number css-l610kl e1c07x480">${prod.reviewCnt}</span>
								</div>
							</div> 
						</a>
						</c:forEach>
						...
						<!-- 할인상품 (시작) -->
						<a href="/goods/1000334648" class="css-9o2zup e1c07x4813">
							<div
							...
							<div class="css-1kpzrna e1c07x489">
								<span class="css-1qd61ut e1ms5t9c1">
									<span class="css-1dry2r1 e1c07x488">상품명</span>
								<div class="e1c07x487  css-1tl7659 ei5rudb2">
									<div>
										<span class="sales-price css-18tpqqq ei5rudb1">가격
