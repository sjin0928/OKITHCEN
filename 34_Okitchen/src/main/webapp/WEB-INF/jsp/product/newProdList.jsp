...
<%-- \${prodListCnt } : ${prodListCnt } <hr> --%>
	...
	<div class="css-nu1lw1 e12kjs5e0">
		...
		<div class="css-ouzwxv eisyv963" style="margin-bottom: 50px;">
				<div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events css-f095o0 eisyv964">
				...
				<div class="swiper-slide swiper-slide-active">
					...
					<div class="css-11kh0cw ef36txc5">
						<c:forEach items="${prodAcceptList }" var="prod">
						<div style="display: inline-block;">
						<a href="${pageContext.request.contextPath }/product/prodDetail.do?productId=${prod.productId}" class="css-9o2zups"
							...
							<div class="button-wrapper">
								<button type="button" class="css-13xu5fn e17x72af0" onclick="handleToAddCart('${prod.productId }')">
							...
							<a href="${pageContext.request.contextPath }/product/prodDetail.do?productId=${prod.productId}" class="css-9o2zup"
							style="text-decoration: none;">
							<div class="css-1kpzrna e1c07x489">
								<span class="css-1qd61ut e1ms5t9c1"></span> 
								<span class="css-1dry2r1 e1c07x488">[${prod.brand }] ${prod.title }</span>
													...
													<div>
														<c:choose>
															...
															<c:otherwise>
																...
																<span class="dimmed-price css-19lkxd2 ei5rudb1"  style="color: rgb(51, 51, 51); font-weight: bold; text-decoration:none;">
																	<fmt:formatNumber value="${prod.price}" type="number"
																		pattern="#,###" /> <span class="won">원</span>
																</span>
															</c:otherwise>
								...
								<div class="review-count css-xezqwk e1c07x482">
									<span class="css-mz5g71 e1c07x481"><svg width="100%"
										...
										class="review-number css-l610kl e1c07x480" style="transform: translateY(2px);">${prod.reviewCnt }</span>
								</div>
							</div> 
						</a>
						</div>
