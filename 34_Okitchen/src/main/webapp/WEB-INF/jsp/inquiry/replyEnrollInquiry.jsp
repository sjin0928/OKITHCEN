...
<body>
	...
	<!-- 문의 작성 폼 -->
	 <form action="inquiryInsert.do?productId=${product.productId}&userId=${loginUser.userId}" id="inquiryForm" method="POST" enctype="multipart/form-data">
	 ...
	 <div>	
		...
		<div>
			<textarea id="contentTitle" name="inqTitle" required></textarea>
		</div>
		<div class="content">
			<label class="inquiryContent" for="inqContent">내용</label>
		</div>
		<div>
			<textarea id="reviewContent" name="inqContent" required></textarea>
		</div>
	</div>
